 ...
 * @author Lucas
 */
public class VendaMes extends javax.swing.JFrame {
    String filtro1 = "", filtro2 = "";
    float valorTotal = 0;
    public VendaMes() {
        initComponents();
        gridVendaMes.getColumnModel().getColumn(0).setPreferredWidth(30);
    ...
    private void initComponents() {
        ...
        gridVendaMes = new javax.swing.JTable();
        ...
        jLabel1.setText("Consulta relatórios de vendas por mês");
        ...
        gridVendaMes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(gridVendaMes);
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        filtro();
        valorTotal = objVenda.vendaMes(gridVendaMes, filtro1, filtro2);
        if (valorTotal == 0) {
    ...
    private void btnExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcelActionPerformed
        ...
        if (excelChooser == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                for (int k = 0; k < gridVendaMes.getColumnCount(); k++) {
                     XSSFCell excelCelula = excelLinha.createCell(k);
                     excelCelula.setCellValue(gridVendaMes.getColumnName(k));
                }
                
                for (int i = 0; i < gridVendaMes.getRowCount(); i++) {
                    excelLinha = excelPlanilha.createRow(i+1);
                    for (int j = 0; j < gridVendaMes.getColumnCount(); j++) {
                        XSSFCell excelCelula = excelLinha.createCell(j);
                        excelCelula.setCellValue(gridVendaMes.getValueAt(i, j).toString());
                    }
                }
                excelLinha = excelPlanilha.createRow(gridVendaMes.getRowCount() + 1);
                excelLinha = excelPlanilha.createRow(gridVendaMes.getRowCount() + 2);
                ...
                for (int i = 0; i < gridVendaMes.getColumnCount(); i++) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendaMes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable gridVendaMes;
